...
import { ITourListing } from "@/data/ResponseInterfaces";
import { useEffect, useState } from "react";

const TourProperties = ({ tours }: { tours: ITourListing[] }) => {
              ...
              <div className="col-md">
                <div className="row x-gap-10 items-center">
                  <div className="col-auto">
                    <p className="text-14 lh-14 mb-5">{item?.name}+ hours</p>
                  </div>
                  {/* End col-auto */}
                  ...
                  <div className="col-auto">
                    <p className="text-14 lh-14 mb-5">{item?.name}</p>
                  </div>
                  {/* End col-auto */}
                </div>
                {/* End .row */}
