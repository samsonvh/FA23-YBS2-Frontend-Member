...
const PopularDestinations = () => {
  return (
    <>
      ...
      <div>
        <button className="section-slider-nav tw-translate-y-8 tw-left-5 lg:tw-left-72 flex-center button -blue-1 bg-white shadow-1 size-40 rounded-full sm:d-none js-destination-prev">
          <i className="icon icon-chevron-left text-12" />
        </button>
        <button className="section-slider-nav tw-translate-y-8 tw-right-5 lg:tw-right-72 flex-center button -blue-1 bg-white shadow-1 size-40 rounded-full sm:d-none js-destination-next">
