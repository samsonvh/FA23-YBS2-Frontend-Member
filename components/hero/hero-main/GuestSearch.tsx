...
const Counter = ({
  ...
  const incrementCount = () => {
    ...
    switch (name) {
      case "Adult":
        setBookingTemp({ ...bookingTemp, adultNumber: count });
      case "Children":
        setBookingTemp({ ...bookingTemp, childrenNumber: count });
    }
  };
...
const GuestSearch = ({
  ...
  useEffect(() => {
    setBookingTemp({
      ...bookingTemp,
      adultNumber: guestCounts.Adults,
      childrenNumber: guestCounts.Children,
    });
  }, []);
